...
class AuthSms(models.Model):
    ...
    def send_sms(self):
        ...
        url = 'https://sens.apigw.ntruss.com/sms/v2/services/ncp:sms:kr:297493987518:sms_test/messages'
        data = {
            "type": "SMS",
            "contentType" : "COMM",
            "from": "01055411336",
    ...
    def	make_signature(self):
        ...
        access_key = "x4pbA8ajyhwvapD1pzmg"				# access key id (from portal or Sub Account)
        secret_key = "YSdTxTSuU9VdcmfC9PRSPGtMyLvAqBvGHAemGgDz"				# secret key (from portal or Sub Account)
        secret_key = bytes(secret_key, 'UTF-8')

        method = "POST"
        URI = '/sms/v2/services/ncp:sms:kr:297493987518:sms_test/messages'
