...
class AuthSms(models.Model):
    ...
    def	make_signature(self):
        ...
        access_key = env('NAVER_ACCESS_KEY')				# access key id (from portal or Sub Account)
        secret_key = env('NAVER_SECRET_KEY')				# secret key (from portal or Sub Account)
